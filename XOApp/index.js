...
function play(y) {
    ...
    //this function is called when the user clicks on a cell of the tic-tac-toe
...
function gameOver(a) {
    var gameOverAlertElement = "<b>gata fratilor, gg </b><br><br> jucatorul cu " + span[a].dataset.player.toUpperCase() + ' a castigat !!! <div>vezi sa nu ti se urce la cap </div><br><br>' + restartButton;
...
function draw() {
    var drawAlertElement = '<b>egalitateee?!?!</b><br><br>' + restartButton;
    var div = document.createElement("div");
    div.className = "alert";
